...
import { ZakatComponent } from 'app/entities/zakat/zakat.component';
import { ZakatService } from 'app/entities/zakat/zakat.service';
import { Zakat } from 'app/shared/model/zakat.model';

describe('Component Tests', () => {
  describe('Zakat Management Component', () => {
    let comp: ZakatComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ZakatComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.zakats && comp.zakats[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
