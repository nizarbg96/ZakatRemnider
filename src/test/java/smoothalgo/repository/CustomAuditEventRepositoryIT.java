...
import smoothalgo.config.audit.AuditEventConverter;
import smoothalgo.domain.PersistentAuditEvent;
...
import static smoothalgo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
