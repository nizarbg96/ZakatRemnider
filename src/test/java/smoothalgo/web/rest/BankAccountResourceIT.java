...
public class BankAccountResourceIT {
    ...
    private static final BigDecimal DEFAULT_RIB = new BigDecimal(1);
    private static final BigDecimal UPDATED_RIB = new BigDecimal(2);
    ...
    public void createBankAccount() throws Exception {
        ...
        assertThat(testBankAccount.getBankAdress()).isEqualTo(DEFAULT_BANK_ADRESS);
        assertThat(testBankAccount.getRib()).isEqualTo(DEFAULT_RIB);
    }
    ...
    @Test
    @Transactional
    public void checkBankAdressIsRequired() throws Exception {
        int databaseSizeBeforeTest = bankAccountRepository.findAll().size();
        // set the field null
        bankAccount.setBankAdress(null);
    ...
    public void getAllBankAccounts() throws Exception {
        ...
        restBankAccountMockMvc.perform(get("/api/bank-accounts?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].bankAdress").value(hasItem(DEFAULT_BANK_ADRESS)))
    ...
    public void getBankAccount() throws Exception {
        ...
        restBankAccountMockMvc.perform(get("/api/bank-accounts/{id}", bankAccount.getId()))
            ...
            .andExpect(jsonPath("$.bankAdress").value(DEFAULT_BANK_ADRESS))
    ...
    public void updateBankAccount() throws Exception {
        ...
        assertThat(testBankAccount.getBankAdress()).isEqualTo(UPDATED_BANK_ADRESS);
        assertThat(testBankAccount.getRib()).isEqualTo(UPDATED_RIB);
    }
