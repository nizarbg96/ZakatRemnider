...
export class UserExtraComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.userExtraService
      ...
      .subscribe(
        (res: HttpResponse<IUserExtra[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IUserExtra[] | null, headers: HttpHeaders, page: number): void {
